import InformeRendimentosPng from '../assets/informeRendimentosIcon.png';
import MeAjudaPng from '../assets/meAjuda.png';
import MeusDadosPng from '../assets/meusDados.png'
import ConfigurarAppPng from '../assets/configurarApp.png';
import PixPng from '../assets/pixIcon.png';
import MudarContaPJPng from '../assets/estabelecimento.png';
import NotificacaoPng from '../assets/notificacao.png';
...
export const dataProfileServices = [
  ...
  { id: '2', title: 'Meus dados', icon: MeusDadosPng, route: 'UserData' },
  ...
  { id: '9', title: 'Sair', icon: ExitPng, route: 'LogoutView' },
]